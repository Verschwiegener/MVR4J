...
/**
 * <p>
 * Java-Klasse für AddressesType complex type.
 * 
 * <p>
...
public class CustomCommands {
	...
	@XmlElement(name = "CustomCommand", required = true)
	protected List<CustomCommand> content;
	 ...
	 * }{@code <}{@link SceneObject }{@code >} {@link JAXBElement
	 * }{@code <}{@link Fixture }{@code >} {@link JAXBElement
	 * }{@code <}{@link Geometry3DType }{@code >} {@link String }
	 * 
	 * 
	 */
	public List<CustomCommand> getContent() {
		if (content == null) {
			content = new ArrayList<CustomCommand>();
		}
		return this.content;
	}
