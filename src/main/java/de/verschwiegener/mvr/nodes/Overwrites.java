...
@XmlType(name = "Overwrites", propOrder = {})
public class Overwrites {

	@XmlElement(name = "Overwrite", required = true)
	protected List<Overwrite> content;
	 ...
	 * 
	 */
	public List<Overwrite> getContent() {
		if (content == null) {
			content = new ArrayList<Overwrite>();
		}
		return this.content;
	}
