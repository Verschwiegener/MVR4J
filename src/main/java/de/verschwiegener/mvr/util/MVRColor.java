...
public class MVRColor {
	 ...
	 */
	public static MVRColor convertxyYToXYZ(double x, double y, double Y) {
		return new MVRColor(x * (Y / y), Y, (1 - x - y) * (Y / y));
	}
	 ...
	 * @return
	 */
	public static MVRColor convertRGBToXYZ(double r, double g, double b) {
	 ...
	 * @return
	 */
	public static MVRColor fromMVR(String xyY) {
		if (xyY.isBlank())
			return null;
